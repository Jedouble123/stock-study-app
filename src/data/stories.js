    ...
    slides: [
      {
        ...
        visual: '🌲🏠🌲',
        text: '숲 속 마을에\n맛있는 빵집이 있었어요.',
        imagePrompt: 'Cute cozy bakery in a forest village, warm lighting, storybook illustration style',
      },
      {
        bg: ['#FEF9C3', '#FDE68A'],
        visual: '🐰💭💰',
        text: '"빵집을 키우고 싶은데\n혼자서는 돈이 부족해..." 🥲',
        imagePrompt: 'Worried cute bunny character looking at empty wallet, thought bubble of bigger bakery',
      },
      {
        bg: ['#DBEAFE', '#BFDBFE'],
        visual: '✂️📄📄📄',
        text: '"주인 자격을 10조각으로\n나눠서 팔자!"',
        imagePrompt: 'A certificate being cut into 10 equal pieces, cute illustration style',
      },
      {
        bg: ['#D1FAE5', '#6EE7B7'],
        visual: '📄⭐',
        text: '이 조각 한 장이 바로\n주식(株式) 1주예요!',
        imagePrompt: 'A glowing share certificate with a star, simple cute illustration',
        realWorld: {
          label: '증권 앱에서는',
    ...
    slides: [
      {
        ...
        visual: '🐿️🐻🦊',
        text: '주식을 산 다람쥐, 곰, 여우—\n이제 모두 빵집의 진짜 주인이에요! 👑',
        imagePrompt: 'Cute squirrel, bear and fox each holding a certificate, celebrating',
      },
      {
        bg: ['#EDE9FE', '#DDD6FE'],
        visual: '🗳️💬',
        text: '빵집 회의에서\n의견도 낼 수 있어요.',
        imagePrompt: 'Animal characters sitting in a meeting room voting, cute illustration',
      },
      {
        bg: ['#D1FAE5', '#A7F3D0'],
        visual: '🏠💰🎁',
        text: '빵집이 잘 될수록\n이익도 함께 나눠요!',
        imagePrompt: 'Money raining on happy animal shareholders, celebrating',
        realWorld: {
          label: '증권 앱에서는',
    ...
    slides: [
      {
        ...
        visual: '🏷️',
        text: '처음엔 빵집 주식\n한 장에 1,000원이었어요.',
        imagePrompt: 'A cute price tag showing 1000 won attached to a bakery sign',
      },
      {
        bg: ['#DBEAFE', '#93C5FD'],
        visual: '📺✨',
        text: '빵집이 TV에 나와서\n온 나라가 주목했어요!',
        imagePrompt: 'TV screen showing a famous bakery, crowd watching excitedly',
      },
      {
        bg: ['#DCFCE7', '#86EFAC'],
        visual: '📈💰',
        text: '사고 싶은 사람이 많을수록\n가격이 올라가요 — 이게 주가예요!',
        imagePrompt: 'Upward arrow chart with coins stacking, bright colors',
        realWorld: {
          label: '증권 앱에서는',
